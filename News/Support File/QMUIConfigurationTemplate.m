...
- (void)applyConfigurationTemplate {
    ...
    QMUICMI.navBarShadowImage = [[UIImage alloc]init];                                            // NavBarShadowImage : UINavigationBar.shadowImage，也即导航栏底部那条分隔线，配合 NavBarShadowImageColor 使用。
    ...
    QMUICMI.navBarTintColor = UIColorGray;                                              // NavBarTintColor : QMUINavigationController.navigationBar 的 tintColor，也即导航栏上面的按钮颜色，由于 tintColor 不支持 appearance，所以这里只支持 QMUINavigationController
    ...
    QMUICMI.tabBarItemTitleColorSelected = UIColorRed;                                 // TabBarItemTitleColorSelected : 选中的 UITabBarItem 的标题颜色
    QMUICMI.tabBarItemImageColor = UIColorGray;                                         // TabBarItemImageColor : UITabBarItem 未选中时的图片颜色
    QMUICMI.tabBarItemImageColorSelected = UIColorRed;                                 // TabBarItemImageColorSelected : UITabBarItem 选中时的图片颜色
